...
var igor = new Person('Igor', 'Gomes Firmino', 27);
...
console.log(igor.getFullName() + " agora tem " + igor.addAge(2).getAge() + " anos.");
console.log(joao.getFullName() + " agora tem " + joao.addAge(7).getAge() + " anos.");
